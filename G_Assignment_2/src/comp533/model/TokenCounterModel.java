...
public class TokenCounterModel extends AMapReduceTracer implements ModelInterface {
    ...
    private BlockingQueue<KeyValue<String, Integer>> boundedBuffer;
    private List<ConcurrentLinkedQueue<KeyValue<String, Integer>>> reductionQueueList;
...
//		this.KeyValueQueue = this.boundedBuffer;
...
//		this.ReductionQueueList = this.reductionQueueList;
...
//        System.out.println((this.reductionQueueList).toString());
    ...
    private void problemSplit() throws InterruptedException {
        ...
        final MapperInterface<String, Integer> mapper = new Mapper();
...
//        System.out.println((this.reductionQueueList).toString());
        for (ConcurrentLinkedQueue<KeyValue<String, Integer>> reductionQueue : this.reductionQueueList) {
            for (KeyValue<String, Integer> keyValues: reductionQueue) {
                ...
                this.traceAddedToMap(result, result);
    ...
    public void setNumThreads(final int newNumThread) {
        this.numThreads = newNumThread;
    }
    ...
    public void terminate() {
    	System.out.println("this assignment is designed horribly");
    }
